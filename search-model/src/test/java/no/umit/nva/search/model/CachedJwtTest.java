...
class CachedJwtTest {
    ...
    private final DecodedJWT jwt1 = Mockito.mock(DecodedJWT.class);
    private final DecodedJWT jwt2 = Mockito.mock(DecodedJWT.class);
    ...
    void setup() {
        ...
        var cognitoAuthenticator = Mockito.mock(CognitoAuthenticator.class);
