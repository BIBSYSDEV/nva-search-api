...
| contributor_name                | contributorName              | fuzzyKeyword | all_items                | entityDescription.contributors.identity.name, entityDescription.contributors.identity.id                                                                                                                                                                                               |
| contributor_name_not            | contributorNameNot           | fuzzyKeyword | no_items                 | entityDescription.contributors.identity.name, entityDescription.contributors.identity.id                                                                                                                                                                                               |
...
| exclude_subunits                | excludeSubunits              | ignored      | all_items                | contributorOrganizations                                                                                                                                                                                                                                                               |
...
| top_level_organization          | topLevelOrganization         | custom       | one_or_more_item         | topLevelOrganizations.id.keyword                                                                                                                                                                                                                                                       |
| unit                            | unit                         | custom       | all_items                | entityDescription.contributors.affiliations.id.keyword                                                                                                                                                                                                                                 |
| unit_not                        | unitNot                      | custom       | no_items                 | entityDescription.contributors.affiliations.id.keyword                                                                                                                                                                                                                                 |
...
| search_all                      | searchAll                    | custom       | one_or_more_item         | q                                                                                                                                                                                                                                                                                      |
## Notes
