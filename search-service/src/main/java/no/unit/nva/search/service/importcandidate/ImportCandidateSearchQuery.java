...
import static no.unit.nva.search.service.importcandidate.ImportCandidateParameter.IMPORT_CANDIDATE_PARAMETER_SET;
import static no.unit.nva.search.service.importcandidate.ImportCandidateParameter.NODES_EXCLUDED;
import static no.unit.nva.search.service.importcandidate.ImportCandidateParameter.NODES_INCLUDED;
import static no.unit.nva.search.service.importcandidate.ImportCandidateParameter.NODES_SEARCHED;
import static no.unit.nva.search.service.importcandidate.ImportCandidateParameter.PAGE;
import static no.unit.nva.search.service.importcandidate.ImportCandidateParameter.SEARCH_AFTER;
