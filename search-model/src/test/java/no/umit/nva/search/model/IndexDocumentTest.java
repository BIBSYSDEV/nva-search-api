...
class IndexDocumentTest {
    ...
    void shouldReturnOpenSearchIndexRequestWithIndexNameSpecifiedByConsumptionAttributes() {
        ...
        MatcherAssert.assertThat(indexRequest.index(), Is.is(equalTo(consumptionAttributes.index())));
    }
    ...
    void
        ...
        MatcherAssert.assertThat(
                ...
                Is.is(equalTo(indexDocument.consumptionAttributes().documentIdentifier().toString())));
    }
