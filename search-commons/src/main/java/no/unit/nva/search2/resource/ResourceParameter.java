...
import static no.unit.nva.search2.common.enums.FieldOperator.ALL_OF;
...
import static no.unit.nva.search2.resource.Constants.REFERENCE_PUBLICATION_CONTEXT_ID_KEYWORD;
...
public enum ResourceParameter implements ParameterKey {
    ...
    COURSE(KEYWORD, ALL_OF, COURSE_CODE_KEYWORD),
    COURSE_NOT(KEYWORD, NOT_ALL_OF, COURSE_CODE_KEYWORD),
    COURSE_SHOULD(KEYWORD, ANY_OF, COURSE_CODE_KEYWORD),
