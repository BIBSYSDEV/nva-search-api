...
public enum ResourceParameter implements ParameterKey {
    ...
    CONTEXT_TYPE_SHOULD(KEYWORD, ANY, PUBLICATION_CONTEXT_TYPE_KEYWORD),
    ...
    FUNDING(KEYWORD, ALL, FUNDINGS_IDENTIFIER_FUNDINGS_SOURCE_IDENTIFIER, null,
    ...
    HANDLE(FUZZY_KEYWORD, ALL, HANDLE_KEYWORD),
    HANDLE_NOT(KEYWORD, NONE, HANDLE_KEYWORD),
    HANDLE_SHOULD(FUZZY_KEYWORD, ANY, HANDLE_KEYWORD),
    ...
    PUBLISHER_ID(TEXT, ALL, PUBLISHER_ID_KEYWORD),
    PUBLISHER_ID_NOT(TEXT, NONE, PUBLISHER_ID_KEYWORD),
    ...
    SERIES(KEYWORD, ALL, ENTITY_DESCRIPTION_REFERENCE_SERIES),
    SERIES_NOT(KEYWORD, NONE, ENTITY_DESCRIPTION_REFERENCE_SERIES),
    SERIES_SHOULD(KEYWORD, ANY, ENTITY_DESCRIPTION_REFERENCE_SERIES),
