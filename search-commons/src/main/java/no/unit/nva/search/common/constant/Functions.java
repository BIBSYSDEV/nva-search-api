...
public final class Functions {
  ...
  /**
   * Create a nested aggregation for labels.
   *
   * @param jsonPath the json path to the labels
   * @return a nested aggregation builder
   */
  ...
  /**
   * Create a Terms field aggregations.
   *
   * @param name the name of the aggregation
   * @param pathElements the path elements to the field
   * @return a TermsAggregationBuilder
   */
  ...
  /**
   * Merge two values with a colon or a comma.
   *
   ...
   *
   * @param fromString a function that converts a string to an enum
   * @param decodedValue the decoded value
   * @return a string with the enum values
   */
  ...
  /**
   * Convert Key and QueryBuilder to an entry stream.
   *
   * @param key the key
