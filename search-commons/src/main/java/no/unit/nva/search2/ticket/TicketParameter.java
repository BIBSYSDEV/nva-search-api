...
import static no.unit.nva.search2.common.constant.Patterns.PATTERN_IS_PUBLICATION_TYPE;
import static no.unit.nva.search2.common.constant.Patterns.PATTERN_IS_PUBLICATION_TYPE_NOT;
...
import static no.unit.nva.search2.ticket.Constants.ORGANIZATION_IDENTIFIER_KEYWORD;
...
public enum TicketParameter implements ParameterKey {
    ...
    PUBLICATION_INSTANCE(FUZZY_KEYWORD, ONE_OR_MORE_ITEM, PUBLICATION_INSTANCE_KEYWORD, PATTERN_IS_PUBLICATION_TYPE, null, null),
    PUBLICATION_INSTANCE_NOT(FUZZY_KEYWORD, NOT_ONE_ITEM, PUBLICATION_INSTANCE_KEYWORD, PATTERN_IS_PUBLICATION_TYPE_NOT, null, null),
