...
/**
 * Filter for Ticket search.
 * <li>Filter on owner (user) and organization.
 * <li>ONLY SET THIS MANUALLY IN TESTS
 * <li>Only documents belonging to organization specified are searchable (for the user)
 *
 * @author Stig Norland
 */
