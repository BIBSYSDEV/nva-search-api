...
public class OaiOmhRequest {
  ...
  public static OaiOmhRequest parse(
      String verb, String from, String until, String metadataPrefix, String resumptionToken) {
    return new OaiOmhRequest(toVerbType(verb), from, until, metadataPrefix, resumptionToken);
  }
