...
import static no.unit.nva.search2.constant.ResourcePaths.ENTITY_DESCRIPTION_CONTRIBUTORS_AFFILIATION_ID;
import static no.unit.nva.search2.constant.ResourcePaths.ENTITY_DESCRIPTION_CONTRIBUTORS_IDENTITY;
import static no.unit.nva.search2.constant.ResourcePaths.ENTITY_DESCRIPTION_CONTRIBUTORS_IDENTITY_ID;
...
import static no.unit.nva.search2.constant.ResourcePaths.ENTITY_DESCRIPTION_REFERENCE_DOI;
import static no.unit.nva.search2.constant.ResourcePaths.ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_CONTEXT_ISBN_LIST;
...
import static no.unit.nva.search2.constant.ResourcePaths.MAIN_TITLE;
