...
public enum TicketSort implements SortKey {
  ...
  /**
   * Returns the TicketSort enum value that corresponds to the given keyName.
   *
   * @param keyName the keyName to match
   * @return the TicketSort enum value that corresponds to the given keyName
   */
  ...
  /**
   * Returns a collection of valid sort keys for Tickets.
   *
   * @return a collection of valid sort keys for Tickets
   */
