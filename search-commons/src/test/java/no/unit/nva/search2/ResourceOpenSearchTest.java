...
public class ResourceOpenSearchTest {
    ...
    class QueryOpensearchInstance {
        ...
        static Stream<URI> uriSortingProvider() {
            return Stream.of(
                URI.create("https://example.com/?category=AcademicChapter&sort=created_date&sortOrder=asc&sort=category&order"
                    + "=desc"),
                URI.create("https://example.com/?category=AcademicChapter&sort=modified_date&sortOrder=asc&sort=category"),
                URI.create("https://example.com/?category=AcademicChapter&sort=published_date&sortOrder=asc&sort=category"),
