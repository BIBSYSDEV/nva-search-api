...
import static no.unit.nva.search.model.constant.ErrorMessages.INVALID_BOOLEAN;
import static no.unit.nva.search.model.constant.ErrorMessages.INVALID_DATE;
import static no.unit.nva.search.model.constant.ErrorMessages.INVALID_NUMBER;
import static no.unit.nva.search.model.constant.ErrorMessages.INVALID_VALUE;
import static no.unit.nva.search.model.constant.ErrorMessages.INVALID_VALUE_WITH_SORT;
import static no.unit.nva.search.model.constant.Patterns.PATTERN_IS_BOOLEAN;
import static no.unit.nva.search.model.constant.Patterns.PATTERN_IS_DATE;
