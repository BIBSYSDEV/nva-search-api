...
public class PagedSearchBuilder {
  ...
  public PagedSearch build() {
    ...
    return new PagedSearch(
        id, totalHits, hits, nextResults, nextSearchAfterResults, previousResults, aggregations);
  }
  ...
  private URI createNextResults(
      Map<String, String> requestParameter, Integer offset, Integer totalSize, URI gatewayUri) {
  ...
  @JacocoGenerated
  private boolean hasNoNextNorSort() {
