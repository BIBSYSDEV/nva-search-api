package no.unit.nva.opensearch.model;

import java.util.Locale;
import no.unit.nva.opensearch.model.common.ParameterKey;
...
import static no.unit.nva.opensearch.constant.Application.UNDERSCORE;
import static no.unit.nva.opensearch.constant.ErrorMessages.INVALID_DATE;
import static no.unit.nva.opensearch.constant.ErrorMessages.INVALID_NUMBER;
import static no.unit.nva.opensearch.constant.ErrorMessages.INVALID_VALUE;
import static no.unit.nva.opensearch.constant.ErrorMessages.INVALID_VALUE_WITH_SORT;
import static no.unit.nva.opensearch.constant.Patterns.PATTERN_IS_IGNORE_CASE;
import static no.unit.nva.opensearch.constant.Patterns.PATTERN_IS_DATE;
import static no.unit.nva.opensearch.constant.Patterns.PATTERN_IS_NONE_OR_ONE;
import static no.unit.nva.opensearch.constant.Patterns.PATTERN_IS_NON_EMPTY;
import static no.unit.nva.opensearch.constant.Patterns.PATTERN_IS_NUMBER;
import static no.unit.nva.opensearch.model.common.ParameterKey.Operator.EQUALS;
import static no.unit.nva.opensearch.model.common.ParameterKey.Operator.GREATER_THAN_OR_EQUAL_TO;
import static no.unit.nva.opensearch.model.common.ParameterKey.Operator.LESS_THAN;
import static no.unit.nva.opensearch.model.common.ParameterKey.ParamKind.CUSTOM;
import static no.unit.nva.opensearch.model.common.ParameterKey.ParamKind.DATE;
import static no.unit.nva.opensearch.model.common.ParameterKey.ParamKind.NUMBER;
import static no.unit.nva.opensearch.model.common.ParameterKey.ParamKind.SORT_STRING;
import static no.unit.nva.opensearch.model.common.ParameterKey.ParamKind.STRING;
