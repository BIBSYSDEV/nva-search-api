package no.unit.nva.search2.handlers;
...
class ImportCandidateHandlerTest {
    ...
    private ImportCandidateHandler handler;
    ...
    void setUp() {
        ...
        handler = new ImportCandidateHandler(new Environment(), mockedSearchClient);
