...
<<<<<<< HEAD:search-service/src/main/java/no/unit/nva/search/service/resource/ResourceParameter.java
...
>>>>>>> main:search-commons/src/main/java/no/unit/nva/search/resource/ResourceParameter.java
...
<<<<<<< HEAD:search-service/src/main/java/no/unit/nva/search/service/resource/  public static final int IGNORE_PARAMETER_INDEX = 0;
...
=======
  ...
  FUNDING_IDENTIFIER_NOT(
      KEYWORD, NOT_ALL_OF, FUNDING_IDENTIFIER_KEYWORD, PATTERN_IS_FUNDING_IDENTIFIER_NOT),
  FUNDING_IDENTIFIER_SHOULD(
      FUZZY_KEYWORD, ANY_OF, FUNDING_IDENTIFIER_KEYWORD, PATTERN_IS_FUNDING_IDENTIFIER_SHOULD),
  FUNDING_SOURCE(TEXT, ALL_OF, FUNDINGS_SOURCE_IDENTIFIER_FUNDINGS_SOURCE_LABELS),
  FUNDING_SOURCE_NOT(TEXT, NOT_ALL_OF, FUNDINGS_SOURCE_IDENTIFIER_FUNDINGS_SOURCE_LABELS),
  FUNDING_SOURCE_SHOULD(TEXT, ANY_OF, FUNDINGS_SOURCE_IDENTIFIER_FUNDINGS_SOURCE_LABELS),
  HANDLE(FUZZY_KEYWORD, ANY_OF, HANDLE_KEYWORD, PHI),
  ...
  HAS_PARENT(PART_OF, ALL_OF, GET_ALL),
  HAS_NO_PARENT(PART_OF, NOT_ALL_OF, GET_ALL),
>>>>>>> main:search-commons/src/main/java/no/unit/nva/search/resource/  NODES_SEARCHED(FLAG, null, null, PATTERN_IS_FIELDS_SEARCHED),
