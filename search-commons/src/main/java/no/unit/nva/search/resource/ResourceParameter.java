...
import static no.unit.nva.search.resource.Constants.ENTITY_DESCRIPTION_NPI_SUBJECT_HEADING_KEYWORD;
...
public enum ResourceParameter implements ParameterKey<ResourceParameter> {
  ...
  HAS_ISBN(EXISTS, ANY_OF, PUBLICATION_CONTEXT_ISBN_LIST),
  ...
  HAS_ISSN(EXISTS, ANY_OF, ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_CONTEXT_ISSN),
  ...
  NPI_SUBJECT_HEADING(KEYWORD, ANY_OF, ENTITY_DESCRIPTION_NPI_SUBJECT_HEADING_KEYWORD),
  NPI_SUBJECT_HEADING_NOT(KEYWORD, NOT_ANY_OF, ENTITY_DESCRIPTION_NPI_SUBJECT_HEADING_KEYWORD),
  NPI_SUBJECT_HEADING_SHOULD(FUZZY_KEYWORD, ANY_OF, ENTITY_DESCRIPTION_NPI_SUBJECT_HEADING_KEYWORD),
  HAS_NPI_SUBJECT_HEADING(EXISTS, ANY_OF, ENTITY_DESCRIPTION_NPI_SUBJECT_HEADING_KEYWORD),
  ...
  ALL_SCIENTIFIC_VALUES(CUSTOM, ANY_OF, SCIENTIFIC_LEVEL_SEARCH_FIELD),
  SCIENTIFIC_VALUE_SERIES(KEYWORD, ANY_OF, SCIENTIFIC_SERIES),
  SCIENTIFIC_VALUE_PUBLISHER(KEYWORD, ANY_OF, SCIENTIFIC_PUBLISHER),
  EXCLUDE_SCIENTIFIC_VALUE_SERIES(KEYWORD, NOT_ANY_OF, SCIENTIFIC_SERIES),
  EXCLUDE_SCIENTIFIC_VALUE_PUBLISHER(KEYWORD, NOT_ANY_OF, SCIENTIFIC_PUBLISHER),
  ...
  GET_ALL(FREE_TEXT),
  HAS_CHILDREN(EXISTS, ANY_OF, CHILD_PUBLICATIONS_KEYWORD),
  HAS_NO_CHILDREN(EXISTS, NOT_ALL_OF, CHILD_PUBLICATIONS_KEYWORD),
  HAS_PARENT(CUSTOM, ALL_OF, REFERENCE_PUBLICATION_CONTEXT_ID_KEYWORD),
  HAS_NO_PARENT(CUSTOM, ALL_OF, REFERENCE_PUBLICATION_CONTEXT_ID_KEYWORD),
