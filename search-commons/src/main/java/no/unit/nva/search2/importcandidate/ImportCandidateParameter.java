...
public enum ImportCandidateParameter implements ParameterKey {
    ...
    INSTANCE_TYPE(KEYWORD, ALL_ITEMS, TYPE_KEYWORD),
    INSTANCE_TYPE_NOT(KEYWORD, NO_ITEMS, TYPE_KEYWORD),
    INSTANCE_TYPE_SHOULD(TEXT, ONE_OR_MORE_ITEM, TYPE_KEYWORD),
    PUBLICATION_INSTANCE(FUZZY_KEYWORD, ONE_OR_MORE_ITEM, PUBLICATION_INSTANCE_TYPE),
    PUBLICATION_INSTANCE_NOT(FUZZY_KEYWORD, NO_ITEMS, PUBLICATION_INSTANCE_TYPE),
    ...
    TOP_LEVEL_ORGANIZATION(FUZZY_KEYWORD, ONE_OR_MORE_ITEM, ORGANIZATIONS_PATH),
    TOP_LEVEL_ORGANIZATION_NOT(FUZZY_KEYWORD, NO_ITEMS, ORGANIZATIONS_PATH),
