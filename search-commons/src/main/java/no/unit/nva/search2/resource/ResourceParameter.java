...
public enum ResourceParameter implements ParameterKey {
    ...
    CONTRIBUTOR(KEYWORD, ALL_ITEMS, CONTRIBUTORS_IDENTITY_ID, null, PATTERN_IS_URI, PHI),
    CONTRIBUTOR_NOT(KEYWORD, NO_ITEMS, CONTRIBUTORS_IDENTITY_ID, null, PATTERN_IS_URI, null),
    CONTRIBUTOR_SHOULD(KEYWORD, ONE_OR_MORE_ITEM, CONTRIBUTORS_IDENTITY_ID, null, PATTERN_IS_URI, PHI),
