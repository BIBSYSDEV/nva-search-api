...
public class ImportCandidateSearchAuthHandler extends ApiGatewayHandler<Void, String> {

    private final ImportCandidateClient opensearchClient;

    @JacocoGenerated
    public ImportCandidateSearchAuthHandler() {
        this(new Environment(), defaultClient());
    }

    public ImportCandidateSearchAuthHandler(Environment environment, ImportCandidateClient candidateClient) {
