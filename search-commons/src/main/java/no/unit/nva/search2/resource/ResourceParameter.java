...
public enum ResourceParameter implements ParameterKey {
    ...
    HAS_FILE(ParameterKind.BOOLEAN, ALL_ITEMS, ATTACHMENT_VISIBLE_FOR_NON_OWNER),
    HAS_FILE_SHOULD(ParameterKind.BOOLEAN, ONE_OR_MORE_ITEM, ATTACHMENT_VISIBLE_FOR_NON_OWNER),
    ...
    ISBN(KEYWORD, PUBLICATION_CONTEXT_ISBN_LIST, PHI),
    ISBN_NOT(KEYWORD, NO_ITEMS, PUBLICATION_CONTEXT_ISBN_LIST),
    ISBN_SHOULD(FUZZY_KEYWORD, ONE_OR_MORE_ITEM, PUBLICATION_CONTEXT_ISBN_LIST),
    ISSN(KEYWORD, ALL_ITEMS, ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_CONTEXT_ISSN),
    ISSN_NOT(KEYWORD, NO_ITEMS, ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_CONTEXT_ISSN),
    ...
    PUBLISHER(KEYWORD, ALL_ITEMS, PUBLICATION_CONTEXT_PUBLISHER),
    PUBLISHER_NOT(KEYWORD, NO_ITEMS, PUBLICATION_CONTEXT_PUBLISHER),
    PUBLISHER_SHOULD(KEYWORD, ONE_OR_MORE_ITEM, PUBLICATION_CONTEXT_PUBLISHER),
