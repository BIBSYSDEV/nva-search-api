...
public class ResourcePaths {
    ...
    public static final String ENTITY_DESCRIPTION_CONTRIBUTORS_AFFILIATION_LABELS_KEYWORD =
        ...
        + PIPE + jsonPath(CONTRIBUTORS_AFFILIATION_LABELS, NYNORSK_CODE, KEYWORD)
        + PIPE + jsonPath(CONTRIBUTORS_AFFILIATION_LABELS, BOKMAAL_CODE, KEYWORD)
        + PIPE + jsonPath(CONTRIBUTORS_AFFILIATION_LABELS, SAMI_CODE, KEYWORD);
    ...
    public static final String ENTITY_DESCRIPTION_CONTRIBUTORS_IDENTITY =
        ...
        + PIPE + CONTRIBUTORS_IDENTITY_NAME_KEYWORD;

    public static final String ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_CONTEXT_ISSN =
        PUBLICATION_CONTEXT_ONLINE_ISSN_KEYWORD
        + PIPE + PUBLICATION_CONTEXT_PRINT_ISSN_KEYWORD;
