...
public enum ResourceParameter implements ParameterKey<ResourceParameter> {
  ...
  EXCLUDE_PARENT_TYPE(KEYWORD, NOT_ALL_OF, PARENT_PUBLICATION_TYPE),
  ...
  EXCLUDE_SCIENTIFIC_VALUE_SERIES(KEYWORD, NOT_ALL_OF, SCIENTIFIC_SERIES),
  EXCLUDE_SCIENTIFIC_VALUE_PUBLISHER(KEYWORD, NOT_ALL_OF, SCIENTIFIC_PUBLISHER),
