package no.unit.nva.indexing.batch.keybatch;

import static no.unit.nva.indexing.batch.Constants.EVENT_BUS;
import static no.unit.nva.indexing.batch.Constants.MANDATORY_UNUSED_SUBTOPIC;
import static no.unit.nva.indexing.batch.Constants.TOPIC;
...
import no.unit.nva.indexing.batch.EventBasedBatchIndexer;
