...
import static no.unit.nva.search.resource.Constants.ENTITY_DESCRIPTION_NPI_SUBJECT_HEADING;
...
public enum ResourceParameter implements ParameterKey<ResourceParameter> {
  ...
  NPI_SUBJECT_HEADING(KEYWORD, ANY_OF, ENTITY_DESCRIPTION_NPI_SUBJECT_HEADING),
  NPI_SUBJECT_HEADING_NOT(KEYWORD, NOT_ANY_OF, ENTITY_DESCRIPTION_NPI_SUBJECT_HEADING),
  NPI_SUBJECT_HEADING_SHOULD(FUZZY_KEYWORD, ANY_OF, ENTITY_DESCRIPTION_NPI_SUBJECT_HEADING),
  HAS_NPI_SUBJECT_HEADING(EXISTS, ANY_OF, ENTITY_DESCRIPTION_NPI_SUBJECT_HEADING),
