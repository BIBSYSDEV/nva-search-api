...
import static no.unit.nva.search.model.constant.Patterns.PATTERN_IS_CATEGORY_KEYS;
import static no.unit.nva.search.model.constant.Patterns.PATTERN_IS_CATEGORY_NOT_KEYS;
...
import static no.unit.nva.search.model.constant.Patterns.PATTERN_IS_FUNDING;
import static no.unit.nva.search.model.constant.Patterns.PATTERN_IS_FUNDING_IDENTIFIER;
import static no.unit.nva.search.model.constant.Patterns.PATTERN_IS_FUNDING_IDENTIFIER_NOT;
import static no.unit.nva.search.model.constant.Patterns.PATTERN_IS_FUNDING_IDENTIFIER_SHOULD;
...
import static no.unit.nva.search.model.constant.Patterns.PATTERN_IS_URI;
...
import static no.unit.nva.search.model.constant.Words.PROJECTS_ID;
...
import static no.unit.nva.search.model.enums.FieldOperator.GREATER_THAN_OR_EQUAL_TO;
import static no.unit.nva.search.model.enums.FieldOperator.LESS_THAN;
...
import static no.unit.nva.search.model.enums.ParameterKind.EXISTS;
...
import static no.unit.nva.search.model.enums.ParameterKind.HAS_PARTS;
...
import static no.unit.nva.search.model.enums.ParameterKind.PART_OF;
...
import static no.unit.nva.search.service.resource.Constants.ASSOCIATED_ARTIFACTS_LICENSE;
import static no.unit.nva.search.service.resource.Constants.CONTRIBUTORS_AFFILIATION_ID_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.CONTRIBUTORS_FIELDS;
import static no.unit.nva.search.service.resource.Constants.CONTRIBUTORS_IDENTITY_ID;
import static no.unit.nva.search.service.resource.Constants.CONTRIBUTORS_IDENTITY_NAME_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.CONTRIBUTORS_IDENTITY_ORC_ID_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.CONTRIBUTOR_COUNT_NO_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.CONTRIBUTOR_ORG_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.COURSE_CODE_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.ENTITY_ABSTRACT;
import static no.unit.nva.search.service.resource.Constants.ENTITY_DESCRIPTION_CONTRIBUTORS_AFFILIATION;
import static no.unit.nva.search.service.resource.Constants.ENTITY_DESCRIPTION_LANGUAGE;
import static no.unit.nva.search.service.resource.Constants.ENTITY_DESCRIPTION_MAIN_TITLE;
import static no.unit.nva.search.service.resource.Constants.ENTITY_DESCRIPTION_PUBLICATION_DATE_YEAR;
import static no.unit.nva.search.service.resource.Constants.ENTITY_DESCRIPTION_PUBLICATION_PAGES;
import static no.unit.nva.search.service.resource.Constants.ENTITY_DESCRIPTION_REFERENCE_CONTEXT_REFERENCE;
import static no.unit.nva.search.service.resource.Constants.ENTITY_DESCRIPTION_REFERENCE_JOURNAL;
import static no.unit.nva.search.service.resource.Constants.ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_CONTEXT_ISSN;
import static no.unit.nva.search.service.resource.Constants.ENTITY_DESCRIPTION_REFERENCE_SERIES;
import static no.unit.nva.search.service.resource.Constants.ENTITY_TAGS;
import static no.unit.nva.search.service.resource.Constants.FILES_STATUS_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.FUNDINGS_IDENTIFIER_FUNDINGS_SOURCE_IDENTIFIER;
import static no.unit.nva.search.service.resource.Constants.FUNDINGS_SOURCE_IDENTIFIER_FUNDINGS_SOURCE_LABELS;
import static no.unit.nva.search.service.resource.Constants.FUNDING_IDENTIFIER_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.HANDLE_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.IDENTIFIER_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.PARENT_PUBLICATION_ID;
import static no.unit.nva.search.service.resource.Constants.PUBLICATION_CONTEXT_ISBN_LIST;
import static no.unit.nva.search.service.resource.Constants.PUBLICATION_CONTEXT_PUBLISHER;
import static no.unit.nva.search.service.resource.Constants.PUBLICATION_CONTEXT_TYPE_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.PUBLICATION_INSTANCE_TYPE;
import static no.unit.nva.search.service.resource.Constants.PUBLISHER_ID_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.REFERENCE_DOI_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.REFERENCE_PUBLICATION_CONTEXT_ID_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.RESOURCE_OWNER_OWNER_AFFILIATION_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.RESOURCE_OWNER_OWNER_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.SCIENTIFIC_INDEX_STATUS_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.SCIENTIFIC_INDEX_YEAR;
import static no.unit.nva.search.service.resource.Constants.SCIENTIFIC_LEVEL_SEARCH_FIELD;
import static no.unit.nva.search.service.resource.Constants.STATUS_KEYWORD;
import static no.unit.nva.search.service.resource.Constants.SUBJECTS;
import static no.unit.nva.search.service.resource.Constants.TOP_LEVEL_ORG_ID;
...
public enum ResourceParameter implements ParameterKey<ResourceParameter> {
    ...
    CONTRIBUTOR(
        KEYWORD, ALL_OF, CONTRIBUTORS_IDENTITY_ID, null, PATTERN_IS_URI),
    CONTRIBUTOR_COUNT(NUMBER, BETWEEN, CONTRIBUTOR_COUNT_NO_KEYWORD),
    CONTRIBUTOR_NOT(
        KEYWORD, NOT_ALL_OF, CONTRIBUTORS_IDENTITY_ID, null, PATTERN_IS_URI),
    CONTRIBUTOR_SHOULD(
        KEYWORD, ANY_OF, CONTRIBUTORS_IDENTITY_ID, null, PATTERN_IS_URI),
    CONTRIBUTOR_NAME(FUZZY_KEYWORD, ALL_OF, CONTRIBUTORS_IDENTITY_NAME_KEYWORD),
    CONTRIBUTOR_NAME_NOT(
        FUZZY_KEYWORD, NOT_ALL_OF, CONTRIBUTORS_IDENTITY_NAME_KEYWORD),
    ...
    EXCLUDE_SUBUNITS(FLAG, CONTRIBUTOR_ORG_KEYWORD),
    FUNDING(
            CUSTOM,
            ALL_OF,
            ...
            PATTERN_IS_FUNDING),
    FUNDING_IDENTIFIER(
        KEYWORD, ALL_OF, FUNDING_IDENTIFIER_KEYWORD, PATTERN_IS_FUNDING_IDENTIFIER),
    ...
    FUNDING_SOURCE_NOT(
        TEXT, NOT_ALL_OF, FUNDINGS_SOURCE_IDENTIFIER_FUNDINGS_SOURCE_LABELS),
    FUNDING_SOURCE_SHOULD(
        TEXT, ANY_OF, FUNDINGS_SOURCE_IDENTIFIER_FUNDINGS_SOURCE_LABELS),
    ...
    INSTANCE_TYPE(
        KEYWORD, ANY_OF, PUBLICATION_INSTANCE_TYPE, PATTERN_IS_CATEGORY_KEYS),
    INSTANCE_TYPE_NOT(
        KEYWORD, NOT_ANY_OF, PUBLICATION_INSTANCE_TYPE, PATTERN_IS_CATEGORY_NOT_KEYS),
    ...
    ISSN_NOT(
        KEYWORD, NOT_ANY_OF, ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_CONTEXT_ISSN),
    ISSN_SHOULD(
        FUZZY_KEYWORD, ANY_OF, ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_CONTEXT_ISSN),
    ...
    PUBLICATION_LANGUAGE_NOT(
        FUZZY_KEYWORD, NOT_ANY_OF, ENTITY_DESCRIPTION_LANGUAGE),
    ...
    PUBLICATION_YEAR_BEFORE(
        NUMBER, LESS_THAN, ENTITY_DESCRIPTION_PUBLICATION_DATE_YEAR),
    ...
    REFERENCE_EXISTS(
        CUSTOM, ALL_OF, ENTITY_DESCRIPTION_REFERENCE_CONTEXT_REFERENCE),
    REFERENCED_ID(FUZZY_KEYWORD, ANY_OF, REFERENCE_PUBLICATION_CONTEXT_ID_KEYWORD),
    SCIENTIFIC_VALUE(CUSTOM, ANY_OF, SCIENTIFIC_LEVEL_SEARCH_FIELD),
    //    SCIENTIFIC_VALUE_OF_PARENT(PART_OF, ANY_OF, SCIENTIFIC_VALUE),
    SCIENTIFIC_INDEX_STATUS(KEYWORD, ANY_OF, SCIENTIFIC_INDEX_STATUS_KEYWORD),
    SCIENTIFIC_INDEX_STATUS_NOT(
        KEYWORD, NOT_ANY_OF, SCIENTIFIC_INDEX_STATUS_KEYWORD),
    SCIENTIFIC_REPORT_PERIOD(NUMBER, BETWEEN, SCIENTIFIC_INDEX_YEAR),
    SCIENTIFIC_REPORT_PERIOD_SINCE(
        NUMBER, GREATER_THAN_OR_EQUAL_TO, SCIENTIFIC_INDEX_YEAR),
    ...
    USER_AFFILIATION_NOT(
        KEYWORD, NOT_ANY_OF, RESOURCE_OWNER_OWNER_AFFILIATION_KEYWORD),
    ...
    SEARCH_AFTER(FLAG),
    SORT(SORT_KEY, null, null, PATTERN_IS_SORT_KEY),
    SORT_ORDER(
        FLAG, ALL_OF, null, PATTERN_IS_SORT_ORDER_KEY, PATTERN_IS_ASC_DESC_VALUE);
