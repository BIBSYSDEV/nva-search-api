...
/**
 * This class operates on the aggregation format that a request provides. The aggregations are
 * formatted to a more readable format.
 *
 * @see <a
 *     href="https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations.html">Elasticsearch
 *     Aggregations</a>
 * @author Stig Norland
 */
