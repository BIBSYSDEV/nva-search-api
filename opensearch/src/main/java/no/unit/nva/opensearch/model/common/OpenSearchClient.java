...
import static no.unit.nva.opensearch.constant.Application.SEARCH_INFRASTRUCTURE_CREDENTIALS;
import static no.unit.nva.opensearch.constant.Application.readSearchInfrastructureAuthUri;
import java.net.URI;
