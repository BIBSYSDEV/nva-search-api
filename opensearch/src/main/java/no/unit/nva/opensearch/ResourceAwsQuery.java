...
import static no.unit.nva.opensearch.constant.Defaults.DEFAULT_OFFSET;
import static no.unit.nva.opensearch.constant.Defaults.DEFAULT_VALUE_PER_PAGE;
import static no.unit.nva.opensearch.constant.Defaults.DEFAULT_VALUE_SORT;
import static no.unit.nva.opensearch.constant.Defaults.DEFAULT_VALUE_SORT_ORDER;
...
import static no.unit.nva.opensearch.model.ResourceParameterKey.PAGE;
import static no.unit.nva.opensearch.model.ResourceParameterKey.SEARCH_AFTER;
...
import static no.unit.nva.opensearch.model.ResourceParameterKey.SORT_ORDER;
import static no.unit.nva.opensearch.model.ResourceParameterKey.keyFromString;
import static no.unit.nva.opensearch.model.ResourceSortKeys.INVALID;
import static no.unit.nva.opensearch.model.ResourceSortKeys.validSortKeys;
import java.net.URI;
import java.util.Arrays;
import java.util.Map;
import java.util.stream.Collectors;
import no.unit.nva.opensearch.model.ResourceParameterKey;
import no.unit.nva.opensearch.model.ResourceSortKeys;
import no.unit.nva.opensearch.model.common.OpenSearchQuery;
import no.unit.nva.opensearch.model.common.OpenSearchQueryBuilder;
...
public final class ResourceAwsQuery extends OpenSearchQuery<ResourceParameterKey> {
    ...
    protected static class Builder extends OpenSearchQueryBuilder<ResourceParameterKey, ResourceAwsQuery> {
        ...
        private String expandFields(String value) {
            return ALL.equals(value) || value.isEmpty()
                       ? "*"
