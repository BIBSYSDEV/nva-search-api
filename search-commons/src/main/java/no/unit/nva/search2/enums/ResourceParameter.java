...
import static no.unit.nva.search2.constant.ResourceFields.ENTITY_DESCRIPTION_CONTRIBUTORS_AFFILIATION_ID;
import static no.unit.nva.search2.constant.ResourceFields.ENTITY_DESCRIPTION_CONTRIBUTORS_AFFILIATION_LABELS;
import static no.unit.nva.search2.constant.ResourceFields.ENTITY_DESCRIPTION_CONTRIBUTORS_IDENTITY_ID;
import static no.unit.nva.search2.constant.ResourceFields.ENTITY_DESCRIPTION_CONTRIBUTORS_IDENTITY_NAME;
import static no.unit.nva.search2.constant.ResourceFields.ENTITY_DESCRIPTION_CONTRIBUTORS_IDENTITY_ORC_ID;
import static no.unit.nva.search2.constant.ResourceFields.ENTITY_DESCRIPTION_PUBLICATION_DATE_YEAR;
import static no.unit.nva.search2.constant.ResourceFields.ENTITY_DESCRIPTION_REFERENCE_DOI;
import static no.unit.nva.search2.constant.ResourceFields.ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_CONTEXT_ISBN_LIST;
import static no.unit.nva.search2.constant.ResourceFields.ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_CONTEXT_ONLINE_ISSN;
import static no.unit.nva.search2.constant.ResourceFields.ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_CONTEXT_PRINT_ISSN;
import static no.unit.nva.search2.constant.ResourceFields.ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_CONTEXT_TYPE_KEYWORD;
import static no.unit.nva.search2.constant.ResourceFields.ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_INSTANCE_TYPE;
import static no.unit.nva.search2.constant.ResourceFields.FUNDINGS_SOURCE_LABELS;
import static no.unit.nva.search2.constant.ResourceFields.IDENTIFIER_KEYWORD;
import static no.unit.nva.search2.constant.ResourceFields.RESOURCE_OWNER_OWNER_AFFILIATION_KEYWORD;
import static no.unit.nva.search2.constant.ResourceFields.RESOURCE_OWNER_OWNER_KEYWORD;
