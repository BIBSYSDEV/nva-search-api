...
public class ImportCandidateSearchHandler extends ApiGatewayHandler<Void, String> {

    private final ImportCandidateClient opensearchClient;

    @JacocoGenerated
    public ImportCandidateSearchHandler() {
        this(new Environment(), defaultClient());
    }

    public ImportCandidateSearchHandler(Environment environment, ImportCandidateClient candidateClient) {
