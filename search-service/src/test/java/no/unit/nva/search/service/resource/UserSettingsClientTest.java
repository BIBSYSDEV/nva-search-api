...
import no.unit.nva.search.model.records.UserSettings;
...
class UserSettingsClientTest {
    ...
    public static void setUp() {
        ...
        when(mochedHttpClient.sendAsync(any(), any()))
                .thenReturn(MockedHttpResponse.mockedFutureHttpResponse(EMPTY_STRING))
                .thenReturn(MockedHttpResponse.mockedFutureFailed())
                .thenReturn(MockedHttpResponse.mockedFutureHttpResponse(path))
                .thenReturn(MockedHttpResponse.mockedFutureHttpResponse(path));
    }
