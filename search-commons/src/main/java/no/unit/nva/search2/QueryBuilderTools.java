...
public final class QueryBuilderTools {
    ...
    static void addKeywordQuery(ParameterKey key, String value, BoolQueryBuilder bq) {
    ...
    static QueryBuilder buildQuery(ParameterKey key, String value) {
    ...
    static RangeQueryBuilder rangeQuery(ParameterKey key, String value) {
    ...
    static Operator operatorByKey(ParameterKey key) {
        return switch (key.searchOperator()) {
    ...
    static String[] extractFields(String field) {
        return ALL.equals(field) || isNull(field)
            ...
            : Arrays.stream(field.split(COMMA))
                .map(ParameterKeyResource::keyFromString)
                .map(ParameterKeyResource::searchFields)
