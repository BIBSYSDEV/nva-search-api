...
import static no.unit.nva.search.resource.Constants.REFERENCE_PUBLICATION_CONTEXT_PUBLICATION_INSTANCE;
...
public enum ResourceParameter implements ParameterKey {
    ...
    REFERENCED_ID(FUZZY_KEYWORD, ANY_OF, REFERENCE_PUBLICATION_CONTEXT_PUBLICATION_INSTANCE),
