...
public enum ResourceParameter implements ParameterKey<ResourceParameter> {
  ...
  FUNDING(
      ...
      null),
  FUNDING_IDENTIFIER(
      KEYWORD, ALL_OF, FUNDING_IDENTIFIER_KEYWORD, PATTERN_IS_FUNDING_IDENTIFIER, null, null, null),
  ...
  SORT_ORDER(
      IGNORED, ALL_OF, null, PATTERN_IS_SORT_ORDER_KEY, PATTERN_IS_ASC_DESC_VALUE, null, null);
  ...
  /**
   * Get the parameter from the key name.
   *
