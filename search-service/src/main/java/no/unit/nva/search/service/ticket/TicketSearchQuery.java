...
import static no.unit.nva.search.service.ticket.Constants.UNHANDLED_KEY;
import static no.unit.nva.search.service.ticket.Constants.facetTicketsPaths;
import static no.unit.nva.search.service.ticket.Constants.getTicketsAggregations;
...
import static no.unit.nva.search.service.ticket.TicketParameter.ASSIGNEE_NOT;
import static no.unit.nva.search.service.ticket.TicketParameter.BY_USER_PENDING;
import static no.unit.nva.search.service.ticket.TicketParameter.EXCLUDE_SUBUNITS;
import static no.unit.nva.search.service.ticket.TicketParameter.FROM;
import static no.unit.nva.search.service.ticket.TicketParameter.NODES_EXCLUDED;
import static no.unit.nva.search.service.ticket.TicketParameter.NODES_INCLUDED;
import static no.unit.nva.search.service.ticket.TicketParameter.NODES_SEARCHED;
import static no.unit.nva.search.service.ticket.TicketParameter.ORGANIZATION_ID;
import static no.unit.nva.search.service.ticket.TicketParameter.PAGE;
import static no.unit.nva.search.service.ticket.TicketParameter.SEARCH_AFTER;
...
import static no.unit.nva.search.service.ticket.TicketParameter.STATUS;
import static no.unit.nva.search.service.ticket.TicketParameter.STATUS_NOT;
import static no.unit.nva.search.service.ticket.TicketParameter.TICKET_PARAMETER_SET;
import static no.unit.nva.search.service.ticket.TicketStatus.NEW;
import static no.unit.nva.search.service.ticket.TicketStatus.PENDING;
    ...
    public static class TicketParameterValidator
        ...
        protected void setValue(String key, String value) {
            ...
            switch (qpKey) {
                ...
                case SORT -> mergeToKey(SORT, Functions.trimSpace(decodedValue));
                case SORT_ORDER -> mergeToKey(SORT, decodedValue);
                case TYPE -> mergeToKey(qpKey, Functions.toEnumStrings(TicketType::fromString, decodedValue));
                case STATUS ->
                        mergeToKey(qpKey, Functions.toEnumStrings(TicketStatus::fromString, decodedValue));
