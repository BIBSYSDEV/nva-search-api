...
import static no.unit.nva.search2.constant.ResourceConstants.DEFAULT_RESOURCE_SORT;
import static no.unit.nva.search2.constant.ResourceConstants.RESOURCES_AGGREGATIONS;
