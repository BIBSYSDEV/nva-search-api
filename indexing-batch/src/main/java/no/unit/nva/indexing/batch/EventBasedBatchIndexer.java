...
import static no.unit.nva.indexing.batch.Constants.NUMBER_OF_FILES_PER_EVENT_ENVIRONMENT_VARIABLE;
import static no.unit.nva.indexing.batch.Constants.RECURSION_ENABLED;
import static no.unit.nva.indexing.batch.Constants.defaultEsClient;
import static no.unit.nva.indexing.batch.Constants.defaultEventBridgeClient;
import static no.unit.nva.indexing.batch.Constants.defaultS3Client;
import static no.unit.nva.indexing.batch.EmitEventUtils.emitEvent;
