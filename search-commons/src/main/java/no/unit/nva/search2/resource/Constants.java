...
public final class Constants {
    ...
    public static final String PUBLICATION_CONTEXT_SERIES_PRINT_ISSN_KEYWORD =
        ENTITY_PUBLICATION_CONTEXT_DOT + SERIES + DOT + ONLINE_ISSN + DOT + KEYWORD;
    public static final String PUBLICATION_CONTEXT_SERIES_ONLINE_ISSN_KEYWORD =
        ENTITY_PUBLICATION_CONTEXT_DOT + SERIES + DOT + PRINT_ISSN + DOT + KEYWORD;
    ...
    public static final String ENTITY_DESCRIPTION_REFERENCE_PUBLICATION_CONTEXT_ISSN =
        PUBLICATION_CONTEXT_ONLINE_ISSN_KEYWORD + PIPE +
        PUBLICATION_CONTEXT_PRINT_ISSN_KEYWORD + PIPE +
        PUBLICATION_CONTEXT_SERIES_PRINT_ISSN_KEYWORD + PIPE +
        PUBLICATION_CONTEXT_SERIES_ONLINE_ISSN_KEYWORD;
