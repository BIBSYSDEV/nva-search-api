...
import static no.unit.nva.search2.resource.Constants.VISIBLE_FOR_NON_OWNER;
...
public enum ResourceParameter implements ParameterKey {
    ...
    DOI_NOT(TEXT, MUST_NOT, REFERENCE_DOI_KEYWORD),
    ...
    ISBN_SHOULD(KEYWORD, SHOULD, PUBLICATION_CONTEXT_ISBN_LIST),
