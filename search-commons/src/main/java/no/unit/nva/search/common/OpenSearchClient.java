...
/**
 * This class is the base class for all OpenSearchClients. It provides the basic functionality for
 * doing a search. It is abstract and must be extended to be used.
 *
 * @author Stig Norland
 */
public abstract class OpenSearchClient<R, Q extends Query<?>> {
  ...
  /**
   * Constructor for OpenSearchClient.
   *
   * @param httpClient HttpClient
   * @param jwtProvider CachedJwtProvider
   */
